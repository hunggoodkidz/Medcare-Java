                            ...
                            <div class="row p-t-20">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-danger">
                                        ...
                                        <input type="date" required name="birthday"  class="form-control form-control-danger" value="<%=d.getBirthday()%>" placeholder="dd/MM/yyyy">
                                    </div>
                                </div>
                                <!--/span-->
                            </div>
                            ...
                            <div class="row p-t-20">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required name="qualification" value="<%=d.getQualification()%>"  class="form-control" placeholder="doe">
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required  name="phone"  value="<%=d.getPhone()%>" class="form-control form-control-danger" placeholder="phone">
                                    </div>
                                </div>
                            </div>
